				...
				<div class="flex flex-col lg:flex-row items-start lg:items-center w-full text-left lg:gap-8">
					...
					<div className="flex flex-col w-auto max-w-full my-4 text-gray-100">
						...
						<a
							...
							className="font-bold font-mono tracking-tight bg-clip-text text-transparent bg-gradient-to-t from-blue-500 via-blue-400 to-blue-300 text-base my-1 hover:underline hover:underline-offset-4 hover:text-blue-300  transition duration-500 ease-in-out"
						>
