...
function Footer() {
  return (
        <footer className="flex flex-col lg:flex-row items-center bg-grayDark justify-between w-full h-full p-8">
        ...
        <div className="flex flex-col w-auto max-w-full my-4 text-gray-100">
          <h2 className="text-xl font-bold tracking-tight font-mono bg-clip-text text-transparent bg-gradient-to-t from-blue-500 via-blue-400 to-blue-300 py-1">Nikki Peel</h2>
          <em className="text-base my-1">Front End Developer</em>
          <a href="mailto:nikkipeel.dev@gmail.com" className="text-base tracking-wide font-bold underline-offset-2 hover:underline my-1">nikkipeel.dev@gmail.com</a>
        </div>
        </div>
